...
openMpScal = 65238
GPFUN_f = "f(x) = x"
plot [:256][]"standardThread300.txt" using 1:(standardScal/$2) w lines title "Standard threads" smooth bezier lw 2, f(x) t "ideal" lw 2, "openMp300.txt" u 1:(openMpScal/$2) t "OpenMP" w lines smooth bezier lw 2
#    EOF
