...
plot [][:50] "mw_50000000.txt" using 1:(seq50000000/$2) w lines title "Master-Worker" smooth bezier, f(x) t "ideal", "pf_50000000.txt" u 1:(seq50000000/$2) t "ParallelFor" w lines smooth bezier
#    EOF
