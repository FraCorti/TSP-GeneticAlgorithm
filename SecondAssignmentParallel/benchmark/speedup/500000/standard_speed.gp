...
plot "mw_500000.txt" using 1:(seq500000/$2) w lines title "Master-Worker" smooth bezier, f(x) t "ideal", "pf_500000.txt" u 1:(seq500000/$2) t "ParallelFor" w lines smooth bezier
#    EOF
